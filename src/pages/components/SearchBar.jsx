    ...
    <div className="w-full">
      ...
      <div className="relative">
        <input
          ...
          className="w-full pl-12 pr-4 py-3 rounded-xl bg-white placeholder-gray-400 text-current focus:outline-none focus:ring-2 focus:ring-primary border border-gray-200"
        />
